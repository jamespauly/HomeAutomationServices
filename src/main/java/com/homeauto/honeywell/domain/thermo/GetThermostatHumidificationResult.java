/**
 * GetThermostatHumidificationResult.java
 *
...
public class GetThermostatHumidificationResult  extends WebMethodResult implements java.io.Serializable {
    private HumidificationInfo humidification;

    public GetThermostatHumidificationResult() {
    }
    ...
    /**
     * Gets the humidification value for this GetThermostatHumidificationResult.
     * 
    ...
    /**
     * Sets the humidification value for this GetThermostatHumidificationResult.
     * 
    ...
    public synchronized boolean equals(Object obj) {
        if (!(obj instanceof GetThermostatHumidificationResult)) return false;
        GetThermostatHumidificationResult other = (GetThermostatHumidificationResult) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GetThermostatHumidificationResult.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://services.alarmnet.com/Services/MobileV2/", "GetThermostatHumidificationResult"));
