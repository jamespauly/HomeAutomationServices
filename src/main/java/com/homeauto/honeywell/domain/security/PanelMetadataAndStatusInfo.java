/**
 * PanelMetadataAndStatusInfo.java
 * <p>
...
public class PanelMetadataAndStatusInfo extends PanelBaseInfo implements java.io.Serializable {
    private ZoneInfo[] zones;

    private boolean promptForImportSecuritySettings;

    public PanelMetadataAndStatusInfo() {
    }
    ...
    /**
     * Gets the zones value for this PanelMetadataAndStatusInfo.
     *
     * @return zones
     */
    ...
    /**
     * Sets the zones value for this PanelMetadataAndStatusInfo.
     *
     * @param zones
     */
    ...
    /**
     * Gets the promptForImportSecuritySettings value for this PanelMetadataAndStatusInfo.
     *
    ...
    /**
     * Sets the promptForImportSecuritySettings value for this PanelMetadataAndStatusInfo.
     *
    ...
    public synchronized boolean equals(Object obj) {
        if (!(obj instanceof PanelMetadataAndStatusInfo)) return false;
        PanelMetadataAndStatusInfo other = (PanelMetadataAndStatusInfo) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
            new org.apache.axis.description.TypeDesc(PanelMetadataAndStatusInfo.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://services.alarmnet.com/TC2/", "PanelMetadataAndStatusInfo"));
