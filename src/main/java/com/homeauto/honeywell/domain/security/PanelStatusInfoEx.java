...
public class PanelStatusInfoEx extends PanelBaseInfoEx implements java.io.Serializable {
    private ZoneStatusInfo[] zones;

    public PanelStatusInfoEx() {
    }
    ...
    /**
     * Gets the zones value for this PanelStatusInfoEx.
     *
     * @return zones
     */
    ...
    /**
     * Sets the zones value for this PanelStatusInfoEx.
     *
     * @param zones
     */
    ...
    public synchronized boolean equals(Object obj) {
        if (!(obj instanceof PanelStatusInfoEx)) return false;
        PanelStatusInfoEx other = (PanelStatusInfoEx) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
            new org.apache.axis.description.TypeDesc(PanelStatusInfoEx.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://services.alarmnet.com/TC2/", "PanelStatusInfoEx"));
